<template>
  <v-container>
    <!-- Conditionally render the filter interface based on showFilterDialog -->
    <v-card v-if="showFilterDialog" class="pa-4">
    ...
    <v-btn @click="showFilterDialog = true">Open Filters</v-btn>
  </v-container>
</template>
...
import Combobox2 from '@/components/items/Combobox.vue' // Import Combobox2.vue

const filterStore = useFilterStore()

// Define a ref to control the visibility of the filter dialog
